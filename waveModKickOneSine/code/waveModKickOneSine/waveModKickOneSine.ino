...
AudioSynthWaveformSine   sine1;          //xy=328,225
AudioSynthWaveformModulated waveformMod1;   //xy=544,201
AudioOutputAnalogStereo  dacs1;          //xy=665,290
AudioConnection          patchCord1(sine1, 0, dacs1, 1);
AudioConnection          patchCord2(sine1, 0, waveformMod1, 0);
AudioConnection          patchCord3(waveformMod1, 0, dacs1, 0);
...
void loop() {
  ...
  float knob_A2 = map(analogRead(A2), 0, 1023, 1.2, 3);
  float knob_A3 = map(analogRead(A3), 0, 1023, 1.2, 50);
