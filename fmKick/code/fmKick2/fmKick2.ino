...
AudioSynthWaveformModulated waveformMod1;   //xy=365,389
...
AudioConnection          patchCord1(waveformMod1, out);
AudioConnection          patchCord2(out, 0, dacs2, 0);
AudioConnection          patchCord3(out, 0, dacs2, 1);
...
void setup() {
  ...
  waveformMod1.begin(1.0, 90, WAVEFORM_SINE);
