...
AudioSynthWaveformSine   sine1;          //xy=288,248
AudioSynthWaveformSine   sine2;          //xy=302,325
AudioSynthWaveformModulated waveformMod1;   //xy=504,224
AudioOutputAnalogStereo  dacs1;          //xy=625,313
AudioConnection          patchCord1(sine1, 0, dacs1, 1);
AudioConnection          patchCord2(sine1, 0, waveformMod1, 0);
AudioConnection          patchCord3(sine2, 0, waveformMod1, 1);
AudioConnection          patchCord4(waveformMod1, 0, dacs1, 0);
// GUItool: end automatically generated code

Bounce button0 = Bounce(30, 150);
...
void setup() {
  ...
  waveformMod1.frequency(90);
  waveformMod1.amplitude(1.0);
  sine1.frequency(8160); // Sine waves are low frequency oscillators (LFO)
  sine2.frequency(1.2);
...
void loop() {
  ...
  float knob_A2 = map(analogRead(A2), 0, 1023, 1.2, 500);
  float knob_A3 = map(analogRead(A3), 0, 1023, 1.2, 500);
